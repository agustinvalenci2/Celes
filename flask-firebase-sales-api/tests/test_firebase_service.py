...
class TestFirebaseService(TestCase):
    ...
    def test_get_total_and_average_sales_by_store(self, mock_firestore):
        ...
        service = FirebaseService()
        total, average = service.get_total_and_average_sales_by_store(
            "store1", "2023-01-01", "2023-01-31"
        )
    ...
    def test_get_total_and_average_sales_by_product(self, mock_firestore):
        ...
        service = FirebaseService()
        total, average = service.get_total_and_average_sales_by_product(
            "prod1", "2023-01-01", "2023-01-31"
        )
    ...
    def test_get_total_and_average_sales_by_employee(self, mock_firestore):
        ...
        service = FirebaseService()
        total, average = service.get_total_and_average_sales_by_employee(
            "emp1", "2023-01-01", "2023-01-31"
        )
